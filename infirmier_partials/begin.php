            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Admissions <span class="badge badge-success">6</span></a>
                            <div id="submenu-1" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="../Infirmier/liste_adm_class.php">Hospitalisation classique</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../Infirmier/liste_adm_jour.php">Hospitalisation du jour</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-calendar-alt"></i>Rendez-vous</a>
                            <div id="submenu-2" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="../Infirmier/ajouter_rendez_vous.php">Ajouter un rendez vous </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../Infirmier/liste_rendez_vous.php">Liste des rendez vous </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>Factures</a>
                            <div id="submenu-4" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="../Infirmier/liste_depense.php">Liste de dépense</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../Infirmier/generer_facture.php">Generer une facture</a>
                                    </li>
