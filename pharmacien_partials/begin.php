            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Entrées <span class="badge badge-success">6</span></a>
                            <div id="submenu-1" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="../pharmacien/ajouter_stock.php">Ajouter un stock</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../pharmacien/modifier_stock.php">Modifier un stock</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../pharmacien/liste.php">Liste de stock</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-calendar-alt"></i>Sorties</a>
                            <div id="submenu-2" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="../pharmacien/sortir.php">Faire sortir un médicament </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../pharmacien/liste.php">Liste de stock </a>
                                    </li>
