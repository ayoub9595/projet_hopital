...
utilisateur.nom,utilisateur.prenom from prescription inner join utilisateur on prescription.idP = utilisateur.idU where prescription.idPres=? and genre='certificat' and Archive=0 ");
...
$content .= '
	...
	<h1 style="text-align:center;">CERTIFICAT MEDICAL</strong></h1>
...
$content .= '
 ...
 <div class="divpar">
 <p class="paragraph"> Je soussigné Dr '.$_SESSION["nom"]." ".$_SESSION["prenom"].'. Je certifie que j\' ai examiné  Mr(Mme/Mlle) '.$results[0]["nom"]." ".$results[0]["prenom"].'. Je présume qu\'il(elle) doit ecopé(e) d\' un repos
  de '.$results[0]["corps"]. ' jours à partir du ' .$results[0]["datePres"].'
 </p>  <br><br><br>';
