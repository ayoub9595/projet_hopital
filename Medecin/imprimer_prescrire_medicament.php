...
utilisateur.nom,utilisateur.prenom from prescription inner join utilisateur on prescription.idP = utilisateur.idU where prescription.idPres=? and genre='medicament' and Archive=0 ");
...
$content .= '
	...
	<h1 style="text-align:center;">ORDONNANCE MEDICAL</strong></h1>
 ...
 <div class="divpar">
 <p class="paragraph"> Je soussigné Dr '.$_SESSION["nom"]." ".$_SESSION["prenom"].'.Je recommande à Mr(Mme/Mlle) '.$results[0]["nom"]." ".$results[0]["prenom"].' les medicaments suivants: <br><br>'
