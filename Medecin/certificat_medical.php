...
?>
<div class="row">
    <h1>Ajouter un certicat medical</h1>
    <div class="col-md-4 offset-3">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                <label for="medicament">Durée</label>
                <textarea rows="1" cols="40" name="medicament" id="medicament"></textarea>
            </div>
...
<?php if(isset($_POST["postuler"])){
    ...
    $req2->execute(array($now,'certificat',$_POST["medicament"],$_SESSION["id"],$idP));
    header("location:liste_certificat_medical.php");
    ob_end_flush();
} ?>
