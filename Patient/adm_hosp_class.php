...
$req = $conn->prepare("select admission.idAd,admission.DateDebut,admission.DateFin,specialite.specialite,admission.etat from admission inner join specialite on admission.idS=specialite.idS where idP= ? and Vu=0 and Archive=0 and typeAd='classique' ");
